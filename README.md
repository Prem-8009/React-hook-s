# Photo Hub - React Custom Hook Assignment

This project is a React application built with Vite and Tailwind CSS. It fetches and displays 80 colorful photos using a specialized custom hook logic as per the assignment guidelines.
...
- **Styling**: Tailwind CSS v4 for modern and fast UI development.
